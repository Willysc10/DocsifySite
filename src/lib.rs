...
#[derive(Debug)]
pub struct DocsifySiteProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DocsifySiteProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DocsifySite processing");
    
    let mut processor = DocsifySiteProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DocsifySiteProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DocsifySiteProcessor::new(false);
